...
namespace ALPHA
{
	namespace XS
	{
		IFPipelinePathologyXSIn::IFPipelinePathologyXSIn() :COMM::IFBase() {}

		IFPipelinePathologyXSIn::IFPipelinePathologyXSIn(std::string& svs_path, std::string& config_path) : COMM::IFBase()
		{
			m_svs_path = svs_path;
