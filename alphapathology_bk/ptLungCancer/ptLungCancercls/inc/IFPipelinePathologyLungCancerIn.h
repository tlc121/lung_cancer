...
namespace ALPHA
{
	namespace LungCancer
	{
		...
		class PIPELINEPATHOLOGYLUNGCANCER_EXPORT IFPipelinePathologyLungCancerIn : public COMM::IFBase
		{
		public:
			explicit IFPipelinePathologyLungCancerIn();
			explicit IFPipelinePathologyLungCancerIn(std::string& svs_path, std::string& config_path);
			~IFPipelinePathologyLungCancerIn() override {}
