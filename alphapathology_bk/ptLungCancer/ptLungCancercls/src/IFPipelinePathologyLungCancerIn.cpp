...
namespace ALPHA
{
	...
	{
		IFPipelinePathologyLungCancerIn::IFPipelinePathologyLungCancerIn() :COMM::IFBase() {}

		IFPipelinePathologyLungCancerIn::IFPipelinePathologyLungCancerIn(std::string& svs_path, std::string& config_path) : COMM::IFBase()
		{
			m_svs_path = svs_path;
